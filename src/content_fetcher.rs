...
use crate::p_folder::DirectoryPortal;
...
pub enum Error {
    ...
    TarIsEmpty,
    #[error("{} for {} not found upstream.\nYou can `enm ls-remote` to see available versions or try a different `--arch`.", version, arch)]
...
mod tests {
    use super::*;
    use crate::content_fetcher::install_node_dist;
    use crate::version::Version;
